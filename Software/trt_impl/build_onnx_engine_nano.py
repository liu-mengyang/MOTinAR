...
from build_model_nano import build_fairmot, load_model
...
with torch.no_grad():
    ...
    torch.onnx.export(net, input_data, 'fairmot_nano.onnx', input_names=input_names, output_names=output_names,
