...
public:
    DCNv2PluginDyn() {
        dlopen("/usr/local/lib/python3.6/dist-packages/torch/lib/libtorch_cuda.so", RTLD_LAZY);
        dlopen("/usr/local/lib/python3.6/dist-packages/torch/lib/libc10_cuda.so", RTLD_LAZY);
    }
